...
videoElement.addEventListener("ended", () => {
  playButton.style.backgroundImage = "url('./icons/SVG/A_button_1.svg')";
});
...
function playPause(){
  ...
  if (videoElement.paused || videoElement.ended) {
    ...
    playButton.style.backgroundImage = "url('./icons/SVG/A_button_down.svg')";
  } else {
...
if(videoElement.muted){
  videoElement.muted = false;
        muteButton.style.backgroundImage = "url('./icons/SVG/Y_button_1.svg')";
} else {
    videoElement.muted = true;
        muteButton.style.backgroundImage = "url('./icons/SVG/Y_button_down.svg')";
  }
}
